...
from models import Ride, Rating, User
...
def rate_user(ride_id, to_user_id):
    ...
    if request.method == 'POST':
        if current_user.id == ride.driver_id:
            rating = create_rating(current_user.id, to_user_id, ride_id, 'driver_to_passenger',
            ...
            rating = create_rating(current_user.id, to_user_id, ride_id, 'passenger_to_driver',
