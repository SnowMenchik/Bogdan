...
# Use file DB in C:\poputka-ai\data to avoid :memory pool issues
DB_PATH = r'C:\poputka-ai\data\poputka.db'
...
# If True, allow any email domain (not just @stud.urfu.ru)
